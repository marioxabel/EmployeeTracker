...
import { getAllEmployees, addEmployee, getAllRoles, addRole, getAllDepartments, addDepartment, greeting, updateEmployeeRole, updateEmployeManager, getEmployeesFromManager, getEmployeesByDepartment, getTotalBudgetByDepartment } from './employeeFunctions.js';
const StartMenu = [
    {
        type: 'list',
        name: 'item',
